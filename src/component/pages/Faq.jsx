...
const FAQ = () => {
    const faqs = [
        {
            question: "Do you have a brick and mortar store of AyurHealth?",
        ...
        },
        {
            ...
            answer: "Currently we deliver through DTDC only. Once dispatched, you will receive a text from DTDC on the contact number as well as on the mail-id provided during check-out with your tracking details. You can track your order 24 hours after your order has been shipped. In case you haven’t received your tracking details through text within 48 hours, please write to us on mailtoAyurHealth@gmail.com or whatsapp us on 91-9820849639."
        },
        {
            question: "What if I don’t receive my product even after the Tracking ID shows ‘Delivered successfully’?",
            answer: "In case of such one-off circumstances, please whatsapp with your concern on +91-9820849639 or drop a mail on mailtoAyurHealth@gmail.com. We’ll do the needful."
        },
        {
        ...
        },
        {
            ...
            answer: "It might happen under rare circumstances due to faulty servers or network issues. In such a case, please get in touch with us with your concern on +91-9820849639 or drop a mail on mailtoAyurHealth@gmail.com."
        },
        {
        ...
        },
        {
            ...
            answer: "If unfortunately you have to cancel/alter an order, please do so within 1-2 hours after placing an order, by mailing us all the details at mailtoAyurHealth@gmail.com. If you cancel your order before it is shipped, we will refund you the entire amount if need be. If we have already dispatched your product, no cancellations can be made."
        },
        {
            question: "Can I modify the delivery address/contact info after having placed an order?",
            answer: "In case of modifications with regards to the delivery, kindly drop us an e-mail at mailtoAyurHealth.com or call us +91-9833526707 within 1-2 hours after placing an order. Once a product has been dispatched, no modifications can be made."
        },
        {
